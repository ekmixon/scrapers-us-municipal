...
def bill_scraper():
    return LametroBillScraper(datadir='', jurisdiction='ocd-division/test')

@pytest.fixture(scope='module')
def event_scraper():
    return LametroEventScraper(datadir='', jurisdiction='ocd-division/test')
...
def api_event():
    ...
    '''
    return {
        'EventLastModifiedUtc': '2018-10-04T18:45:31.123',
        'status': 'passed',
...
def web_event():
    ...
    return {
        ...
        'Name': {
            'label': 'Board of Directors - Regular Board Meeting',
            'url': '',
        },
...
def event_agenda_item():
    ...
    '''
    return {
        'EventItemGuid': '57DC7258-0E6D-42CA-BB9A-717FCC96E436',
